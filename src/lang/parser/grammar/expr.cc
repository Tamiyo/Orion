...
#include "lang/parser/grammar/infix_op.h"
#include "lang/parser/grammar/postfix_op.h"
#include "lang/parser/grammar/prefix_op.h"
...
std::optional<syntax::CompletedMarker> Lhs(Parser* p) noexcept {
  ...
  switch (kind.value()) {
    ...
    case TokenKind::kBooleanLit:
    case TokenKind::kStringLit:
    case TokenKind::kBigDecimalLit:
    case TokenKind::kBigIntLit:
    case TokenKind::kIntLit:
    case TokenKind::kSmallIntLit:
    case TokenKind::kTinyIntLit:
