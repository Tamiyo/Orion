...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        LexerParam{U"(",
                   std::vector<Token>{
                       Token(TokenKind::LeftParen, U"(", 0, 1)}},
        LexerParam{U")",
                   std::vector<Token>{
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        LexerParam{U"0",
                   std::vector<Token>{
                       Token(TokenKind::IntegerLiteral, U"0", 0, 1)}},
        LexerParam{U"123",
                   std::vector<Token>{
                       Token(TokenKind::IntegerLiteral, U"123", 0, 3)}},
        LexerParam{U"1_000_000",
                   std::vector<Token>{Token(TokenKind::IntegerLiteral,
                                            U"1_000_000", 0, 9)}}));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        LexerParam{U"3.14",
                   std::vector<Token>{
                       Token(TokenKind::FloatLiteral, U"3.14", 0, 4)}},
        LexerParam{U"0.0",
                   std::vector<Token>{
                       Token(TokenKind::FloatLiteral, U"0.0", 0, 3)}},
        ...
        LexerParam{U"1e-5",
                   std::vector<Token>{
                       Token(TokenKind::FloatLiteral, U"1e-5", 0, 4)}},
        LexerParam{U"1e+10",
                   std::vector<Token>{
                       Token(TokenKind::FloatLiteral, U"1e+10", 0, 5)}},
        LexerParam{U"1.5e10",
                   std::vector<Token>{
                       Token(TokenKind::FloatLiteral, U"1.5e10", 0, 6)}},
        LexerParam{U".5e-3",
                   std::vector<Token>{
                       Token(TokenKind::FloatLiteral, U".5e-3", 0, 5)}},
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        LexerParam{U"\"\"",
                   std::vector<Token>{
                       Token(TokenKind::StringLiteral, U"\"\"", 0, 2)}},
        LexerParam{U"\"hello\"",
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        LexerParam{U"0x1A",
                   std::vector<Token>{
                       Token(TokenKind::HexLiteral, U"0x1A", 0, 4)}},
        LexerParam{U"0XFF",
                   std::vector<Token>{
                       Token(TokenKind::HexLiteral, U"0XFF", 0, 4)}},
        LexerParam{U"0x1_FF_AB",
                   std::vector<Token>{Token(TokenKind::HexLiteral,
                                            U"0x1_FF_AB", 0, 9)}},
        // `0x` with no hex digits is an error token spanning the prefix.
        LexerParam{U"0x",
                   std::vector<Token>{
                       Token(TokenKind::Error, U"0x", 0, 2)}}));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        LexerParam{U"0b0",
                   std::vector<Token>{
                       Token(TokenKind::BinaryLiteral, U"0b0", 0, 3)}},
        LexerParam{U"0b101",
                   std::vector<Token>{
                       Token(TokenKind::BinaryLiteral, U"0b101", 0, 5)}},
        LexerParam{U"0B1_0_1",
                   std::vector<Token>{Token(TokenKind::BinaryLiteral,
                                            U"0B1_0_1", 0, 7)}},
        // `0b` with no binary digits is an error token spanning the prefix.
        LexerParam{U"0b",
                   std::vector<Token>{
                       Token(TokenKind::Error, U"0b", 0, 2)}}));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        LexerParam{U"true",
                   std::vector<Token>{
                       Token(TokenKind::BooleanLiteral, U"true", 0, 4)}},
        LexerParam{U"false",
                   std::vector<Token>{
                       Token(TokenKind::BooleanLiteral, U"false", 0, 5)}}));

INSTANTIATE_TEST_SUITE_P(
    Identifiers, LexerTokenTest,
    ::testing::Values(
        LexerParam{U"my_1d3nt",
                   std::vector<Token>{
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        LexerParam{U"mut",
                   std::vector<Token>{
                       Token(TokenKind::MutKw, U"mut", 0, 3)}}));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        LexerParam{U"let x = 42",
                   std::vector<Token>{
                       Token(TokenKind::LetKw, U"let", 0, 3),
