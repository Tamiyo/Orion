...
void TokenKindGenerator::emitClassDefinitions(
  ...
  sortAndEmitRecords("WhitespaceToken", "Whitespace", tokens);
...
void TokenKindGenerator::emitInlineMethods(
  ...
  auto sortAndEmitInlineMethods = [&os](const std::string &subclass,
  ...
  sortAndEmitInlineMethods("WhitespaceToken", "Whitespace", tokens);
