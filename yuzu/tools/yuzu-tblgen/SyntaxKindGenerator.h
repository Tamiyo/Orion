#ifndef YUZU_TOOLS_SYNTAX_KIND_GENERATOR_H
#define YUZU_TOOLS_SYNTAX_KIND_GENERATOR_H
...
class SyntaxKindGenerator final : public CppGenerator {
public:
  explicit SyntaxKindGenerator(
