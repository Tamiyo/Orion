...
using SyntaxNode = yuzu::syntax::api::SyntaxNode<SyntaxKind>;
using SyntaxToken = yuzu::syntax::api::SyntaxToken<SyntaxKind>;
using SyntaxElement = yuzu::syntax::api::SyntaxElement<SyntaxKind>;
