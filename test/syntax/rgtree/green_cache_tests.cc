...
constexpr SyntaxKind kTestSyntaxKindPlus = SyntaxKind::kPlus;
constexpr SyntaxKind kTestSyntaxKindMinus = SyntaxKind::kMinus;

constexpr std::u32string_view kTestSource1 = U"hello world";
constexpr std::u32string_view kTestSource2 = U"goodbye world";
